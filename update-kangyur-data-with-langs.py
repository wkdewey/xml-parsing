...
final_sheet_path = '/users/williamdewey/Development/code/84000-data-rdf/xml-parsing/data-export/WD_BDRC_data_with_langs.xlsx'

final = Path(final_sheet_path)
final_sheet = ""
if final.exists():
    final_sheet = pd.read_excel(final)
for text in dataset.texts:
    for work in text.works:
...
new_attributions_df.to_excel("new_attributions_with langs.xlsx")

tree.write("new-kangyur-data-for-import.xml")